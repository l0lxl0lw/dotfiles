...
Read `~/dotfiles/opencode/tracking/WORKFLOW.md` once. Load `handoff.py packet ISSUE --stage review` with
...
Use `~/dotfiles/opencode/schemas/review.example.json` and publish **Review** with
