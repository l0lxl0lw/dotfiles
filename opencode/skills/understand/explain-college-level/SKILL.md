...
**REQUIRED: read `~/dotfiles/opencode/skills/understand/_lib/grounding.md` and follow it before the first sentence.** It owns topic
...
Register alone is not what this skill is for — `~/dotfiles/opencode/skills/understand/_lib/explaining.md` owns that, and it demands no
...
**REQUIRED: follow `~/dotfiles/opencode/skills/understand/_lib/explaining.md`.** It owns the voice: real mechanism, terminology defined
