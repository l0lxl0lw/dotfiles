...
topic has no implementation in this repo, are owned by `~/dotfiles/opencode/skills/understand/_lib/grounding.md`.

## Step 1 — Ground yourself in the real implementation

**REQUIRED: read `~/dotfiles/opencode/skills/understand/_lib/grounding.md` and follow it completely before explaining anything.** It
...
**REQUIRED: follow `~/dotfiles/opencode/skills/understand/_lib/explaining.md`** — it owns the voice and the `relative/path.ext:LINE`
