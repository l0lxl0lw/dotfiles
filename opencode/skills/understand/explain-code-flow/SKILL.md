...
**REQUIRED: read `~/dotfiles/opencode/skills/understand/_lib/grounding.md` and follow it first.** It owns topic and path resolution,
the read order, and what to extract.

## Step 2 — Explain the concept

**REQUIRED: follow `~/dotfiles/opencode/skills/understand/_lib/explaining.md`.** Real mechanism, terminology defined inline, nothing
