...
**REQUIRED: read `~/dotfiles/opencode/skills/understand/_lib/grounding.md` and follow it before writing a single question.** It owns
...
1. **Teach it at college level, per `~/dotfiles/opencode/skills/understand/_lib/explaining.md`** — which owns the voice and the
