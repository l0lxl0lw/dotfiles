...
The complete prompt below is vendored from Cluster444/agentic. Prefer current
code and tests over historical plans, and identify differences that prevent blind
copying of an example.
