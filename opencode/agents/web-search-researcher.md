...
The complete prompt below is vendored from Cluster444/agentic. Ignore its obsolete
note that OpenCode has no web access: use the web tools currently available to you,
prefer official and versioned primary sources, and return direct URLs with version
or date context, limitations, and unresolved questions.
