...
Read `~/dotfiles/ai/opencode/tracking/WORKFLOW.md` and follow its contract. The
upstream Agentic prompt below supplies the interview method and ticket-quality
criteria, but this local contract wins wherever they conflict: tickets are GitHub
